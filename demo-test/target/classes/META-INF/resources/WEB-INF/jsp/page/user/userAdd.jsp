                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form id="addForm" class="form-horizontal">
                                <div class="form-group"><label class="col-sm-2 control-label">用户名(<span style="color:red">*</span>)</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" id="userName" name="userName" maxlength="50"></div>
                                </div>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">角色(<span style="color:red">*</span>)</label>
									<div class="input-group">
						                 &nbsp;&nbsp;&nbsp;&nbsp;<select id="roleSelector" name="roleSelector" data-placeholder="选择角色..." class="chosen-select" style="width:350px;" tabindex="4">
							                <c:forEach items="${allRoleList}" var="role" varStatus="status">
							                	<option value="${role.roleId}"><c:out value="${role.roleName}" escapeXml="true" /></option>
							                </c:forEach>
						                </select>
	           						</div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                    	<a href="javascript:void(0);" onclick="addUser();" class="btn btn-primary" role="button"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> 保存</a>
