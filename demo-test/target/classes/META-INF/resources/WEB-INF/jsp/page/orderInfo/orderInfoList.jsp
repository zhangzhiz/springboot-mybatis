                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
	                    	<div style="float:left;">
								...
								<input type="text" class="form-control" style="width:300px; float:left; " id="productName" name="productName" placeholder="产品名称"
	                    			onkeypress="enterPress(event)" onkeydown="enterPress()" />&nbsp;&nbsp;
								<input type="text" class="form-control" style="width:300px; float:left; " id="productColor" name="productColor" placeholder="产品颜色"
	                    			onkeypress="enterPress(event)" onkeydown="enterPress()" />&nbsp;&nbsp;
								<input type="text" class="form-control" style="width:300px; float:left; " id="productWeight" name="productWeight" placeholder="产品重量"
	                    			onkeypress="enterPress(event)" onkeydown="enterPress()" />&nbsp;&nbsp;
								<input type="text" class="form-control" style="width:300px; float:left; " id="productPrice" name="productPrice" placeholder="产品价格"
	                    			onkeypress="enterPress(event)" onkeydown="enterPress()" />&nbsp;&nbsp;
								<input type="text" class="form-control" style="width:300px; float:left; " id="createCompany" name="createCompany" placeholder="生产厂家"
	                    			onkeypress="enterPress(event)" onkeydown="enterPress()" />&nbsp;&nbsp;
								<input type="text" class="form-control" style="width:300px; float:left; " id="createTime" name="createTime" placeholder="生产日期"
	                    			onkeypress="enterPress(event)" onkeydown="enterPress()" />&nbsp;&nbsp;
			            ...
			            <!-- 表格 -->
			            <div id="tableDiv">
							<jsp:include page="/WEB-INF/jsp/page/orderInfo/orderInfoTable.jsp" />
						</div>
                    </div>
                    </form>
                </div>
