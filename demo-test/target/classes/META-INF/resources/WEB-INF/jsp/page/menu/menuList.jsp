                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                    	<div style="float:left;">
                    		<input type="text" class="form-control" style="width:300px; float:left; " id="menuName" name="menuName" placeholder="菜单名称"
			            ...
			            <div class="" style="float:right">
				            	...
				            	<a href="javascript:void(0);" onclick="toAddPage();" class="btn btn-primary ">
			            			<span class="glyphicon glyphicon-plus" aria-hidden="true"></span> 新增菜单</a>&nbsp;
			            		<a href="javascript:void(0);" onclick="enableMenu();" class="btn btn-outline btn-default ">
				            		<span class="glyphicon glyphicon-ok-circle" aria-hidden="true"></span> 批量启用</a>&nbsp;
			            		<a href="javascript:void(0);" onclick="disableMenu();" class="btn btn-outline btn-default ">
				            		<span class="glyphicon glyphicon-ban-circle" aria-hidden="true"></span> 批量禁用</a>
			            </div>
			            <!-- 表格 -->
			            <div id="tableDiv">
							<jsp:include page="/WEB-INF/jsp/page/menu/menuTable.jsp" />
						</div>
                    </div>
                    </form>
                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>是否要删除选择的记录？</p>
                        <p>菜单名称：<label id="del_user_name" ></label></p>
                    </div>
